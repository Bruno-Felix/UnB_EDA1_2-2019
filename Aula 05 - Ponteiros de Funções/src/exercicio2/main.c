...
//Verificar se h� pelo menos um valor a ser impresso:
    ...
    if(ptemcalculo)
    {
//C�lculo e visualiza��o de Estat�sticas Selecionadas:
        system("cls");
        printf("\n\n####################### ESTATISTICAS ###################################");
        for(pp=0; pp<pqtde; pp++)
        {
...
int main()
{
    ...
    do{
        menu = MontaTela(popers, 5, pserie, 20);
        CalculaEMostra(Operacoes, Nomes, Selecao, 5, pserie, 20);
    }
    while(menu != 'E');
